...
def ratchet(NumberCycles=2,nu_f_values=nu_f_values,SimulationWidth_values=SimulationWidth_values, PointsPerCycle_values=PointsPerCycle_values, OutputCycles=OutputCycles):
